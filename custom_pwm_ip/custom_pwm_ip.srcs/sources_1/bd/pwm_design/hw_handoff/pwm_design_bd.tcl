...
################################################################
# This is a generated script based on design: pwm_design
#
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set pwm_pout [ create_bd_port -dir O pwm_pout ]
...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins pwm_core_0/S00_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins pwm_core_0/s00_axi_aclk] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net pwm_core_0_pwm_pout [get_bd_ports pwm_pout] [get_bd_pins pwm_core_0/pwm_pout]
  connect_bd_net -net rst_ps7_0_50M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_50M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins pwm_core_0/s00_axi_aresetn] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pwm_core_0/S00_AXI/S00_AXI_reg] SEG_pwm_core_0_S00_AXI_reg
...
preplace port pwm_pout -pg 1 -y 130 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 270 -defaultsOSRD
preplace inst rst_ps7_0_50M -pg 1 -lvl 1 -y 130 -defaultsOSRD
preplace inst pwm_core_0 -pg 1 -lvl 3 -y 130 -defaultsOSRD
...
preplace netloc pwm_core_0_pwm_pout 1 3 1 NJ
