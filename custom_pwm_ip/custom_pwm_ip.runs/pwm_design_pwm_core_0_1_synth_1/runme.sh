...
HD_PWD='D:/VivadoProjects/custom_pwm_ip/custom_pwm_ip.runs/pwm_design_pwm_core_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_design_pwm_core_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pwm_design_pwm_core_0_1.tcl
