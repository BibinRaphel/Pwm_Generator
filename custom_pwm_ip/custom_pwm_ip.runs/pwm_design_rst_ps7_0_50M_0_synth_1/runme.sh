...
HD_PWD='D:/VivadoProjects/custom_pwm_ip/custom_pwm_ip.runs/pwm_design_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_design_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pwm_design_rst_ps7_0_50M_0.tcl
