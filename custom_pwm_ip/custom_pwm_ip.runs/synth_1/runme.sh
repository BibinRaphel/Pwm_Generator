...
HD_PWD='D:/VivadoProjects/custom_pwm_ip/custom_pwm_ip.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pwm_design_wrapper.tcl
