...
HD_PWD='D:/VivadoProjects/custom_pwm_ip/custom_pwm_ip.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pwm_design_wrapper.tcl -notrace
